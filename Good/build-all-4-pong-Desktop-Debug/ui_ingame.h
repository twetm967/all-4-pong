...
public:
    ...
    QLabel *lblLife4PR;
    QPushButton *btnHome;
    QLabel *lblGameDeclaration;
    QLabel *lblPlayDeclaration;
...
"border-radius: 10px;"));
        ...
        lblLife6PB->setGeometry(QRect(395, 580, 20, 20));
...
"border-radius: 10px;"));
        ...
        lblUsernamePR->setGeometry(QRect(745, 335, 131, 20));
...
"text-align: center;"));
        ...
        lblPlayerBoardR->setGeometry(QRect(720, 270, 200, 100));
...
"text-align: center;"));
        ...
        lblLife2PR->setGeometry(QRect(760, 280, 20, 20));
...
"border-radius: 10px;"));
        ...
        lblLife5PB->setGeometry(QRect(370, 580, 20, 20));
...
"border-radius: 4px;"));
        ...
        lblPlayerBoardB->setGeometry(QRect(260, 565, 451, 50));
...
"border-radius: 4px;"));
        ...
        lblScorePB->setGeometry(QRect(470, 580, 61, 17));
...
"text-align: center;"));
        ...
        lblLife3PR->setGeometry(QRect(785, 280, 20, 20));
...
"text-align: center;"));
        ...
        lblLife7PR->setGeometry(QRect(885, 280, 20, 20));
...
"border-radius: 4px;"));
        ...
        lblPaddleRight->setStyleSheet(QLatin1String("border-radius: 4px;\n"
...
"text-align: center;"));
        ...
        lblLife6PR->setGeometry(QRect(860, 280, 20, 20));
...
"border-radius: 10px;"));
        ...
        lblLife4PB->setGeometry(QRect(345, 580, 20, 20));
...
"border-radius: 10px;"));
        ...
        lblLife3PB->setGeometry(QRect(320, 580, 20, 20));
...
"border-radius: 10px;"));
        ...
        lblLife1PB->setGeometry(QRect(270, 580, 20, 20));
...
"text-align: center;"));
        ...
        lblScorePR->setGeometry(QRect(745, 310, 61, 17));
...
"text-align: center;"));
        ...
        lblLife5PR->setGeometry(QRect(835, 280, 20, 20));
...
"border-radius: 10px;"));
        ...
        lblLife7PB->setGeometry(QRect(420, 580, 20, 20));
...
"text-align: center;"));
        ...
        lblUsernamePB->setGeometry(QRect(560, 580, 131, 20));
...
"text-align: center;"));
        ...
        lblLife1PR->setGeometry(QRect(735, 280, 20, 20));
...
"border-radius: 10px;"));
        ...
        lblLife2PB->setGeometry(QRect(295, 580, 20, 20));
...
"border-radius: 10px;"));
        ...
        lblLife4PR->setGeometry(QRect(810, 280, 20, 20));
...
"color: rgb(0, 200, 0);\n"
"border-radius: 30px;"));
        lblGameDeclaration = new QLabel(InGame);
        lblGameDeclaration->setObjectName(QStringLiteral("lblGameDeclaration"));
        lblGameDeclaration->setGeometry(QRect(290, 240, 391, 71));
        QFont font1;
        ...
        font1.setWeight(75);
        lblGameDeclaration->setFont(font1);
        lblGameDeclaration->setMouseTracking(true);
        lblGameDeclaration->setStyleSheet(QLatin1String("background-color: none;\n"
"color: rgb(255, 255, 255);"));
        ...
        font2.setWeight(75);
        lblPlayDeclaration->setFont(font2);
        lblPlayDeclaration->setMouseTracking(true);
        lblPlayDeclaration->setStyleSheet(QLatin1String("background-color: none;\n"
"color: rgb(255, 255, 255);"));
        gameCourt->raise();
        ...
        lblLife2PT->raise();
        btnHome->raise();
        lblGameDeclaration->raise();
        lblPlayDeclaration->raise();
    ...
    void retranslateUi(QWidget *InGame)
    {
        ...
        lblScorePB->setText(QApplication::translate("InGame", "0", 0));
        ...
        lblScorePR->setText(QApplication::translate("InGame", "0", 0));
        lblLife5PR->setText(QString());
        lblLife7PB->setText(QString());
        lblScorePL->setText(QApplication::translate("InGame", "0", 0));
        ...
        lblGameDeclaration->setText(QString());
        lblPlayDeclaration->setText(QString());
    } // retranslateUi
