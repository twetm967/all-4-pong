...
public:
    ...
    void setupUi(QMainWindow *Start)
    {
        ...
        start_Btn->setGeometry(QRect(600, 80, 131, 121));
...
"border-radius: 48px;"));
        ...
        players_comboBox->setGeometry(QRect(270, 430, 61, 27));
        QFont font;
...
"border: 1px solid rgb(0, 200, 0);"));
        ...
        label->setGeometry(QRect(60, 430, 201, 31));
        QFont font1;
...
"border: 1px solid rgb(0, 200, 0);"));
        ...
        power_checkBox->setGeometry(QRect(810, 460, 181, 31));
...
"background-color: rgba(0, 200, 255, 0);"));
        ...
        lblConnected->setGeometry(QRect(150, 480, 151, 31));
        ...
        username_le->setGeometry(QRect(590, 370, 161, 27));
        username_le->setStyleSheet(QLatin1String("color: rgb(71, 71, 71);\n"
"background-color: rgb(0, 200, 0);\n"
"border: 1px solid rgb(0, 200, 0);"));
        btnLoad = new QPushButton(centralwidget);
        btnLoad->setObjectName(QStringLiteral("btnLoad"));
        btnLoad->setEnabled(true);
        btnLoad->setGeometry(QRect(850, 110, 181, 61));
        btnLoad->setFocusPolicy(Qt::NoFocus);
        btnLoad->setStyleSheet(QLatin1String("background-color: rgb(71, 71, 71);\n"
"color: rgb(0, 200, 0);\n"
"border-radius: 30px;\n"
"border: 2px solid rgb(0,200,0);"));
    ...
    void retranslateUi(QMainWindow *Start)
    {
        ...
        power_checkBox->setText(QApplication::translate("Start", "Pop-up-Blocks", 0));
        lblConnected->setText(QApplication::translate("Start", "Users: 1", 0));
        lblBckgrndImg->setText(QString());
        label_3->setText(QApplication::translate("Start", "Username", 0));
        btnLoad->setText(QApplication::translate("Start", "Load Last Game", 0));
